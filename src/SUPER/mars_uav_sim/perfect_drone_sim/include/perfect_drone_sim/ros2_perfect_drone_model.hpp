...
#include "mars_super_msgs/msg/position_command.hpp"
...
namespace perfect_drone {
    class PerfectDrone : public rclcpp::Node {
        ...
        rclcpp::Subscription<mars_super_msgs::msg::PositionCommand>::SharedPtr cmd_sub_;
...
#define CONFIG_FILE_DIR(name) (std::string(std::string(ROOT_DIR) + "config/"+(name)))
            ...
            cmd_sub_ = this->create_subscription<mars_super_msgs::msg::PositionCommand>(
    ...
    private:
        void cmdCallback(const mars_super_msgs::msg::PositionCommand::SharedPtr msg) {
