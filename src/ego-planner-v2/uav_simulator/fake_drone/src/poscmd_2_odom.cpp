...
bool ego_or_super = false;  // false=ego, true=SUPER
...
void pubOdom()
{
	...
	if (rcv_cmd)
	{
		...
		else // SUPER mode
		{
			...
			Eigen::Vector3d alpha = Eigen::Vector3d(_super_cmd.acceleration.x, _super_cmd.acceleration.y, _super_cmd.acceleration.z) + 9.8*Eigen::Vector3d(0,0,1);
...
int main (int argc, char** argv)
{
	...
	nh.param("ego_or_super", ego_or_super, false);  // false=ego, true=SUPER
