  ...
  auto operator()() const {
    ...
    return make_transition_table(
        *state<Idle> + event<Tick> / EnableBothCameras{},
        ...
        FSM_CTRL_FLIGHT_FSM_MISSION_COMMAND_TRANSITIONS(NmpcHover),
        FSM_CTRL_FLIGHT_FSM_MISSION_COMMAND_TRANSITIONS(SuperTrack),
        FSM_CTRL_FLIGHT_FSM_MISSION_COMMAND_TRANSITIONS(Landing),
        FSM_CTRL_FLIGHT_FSM_MISSION_COMMAND_TRANSITIONS(Emergency),
        FSM_CTRL_FLIGHT_FSM_MISSION_COMMAND_TRANSITIONS(SafeNoop));
  }
};
  ...
  auto operator()() const {
    ...
    return make_transition_table(
        *state<Idle> + event<Tick> / EnableBothCameras{},
        ...
        FSM_CTRL_FLIGHT_FSM_SEGMENTED_MISSION_COMMAND_TRANSITIONS(NmpcHover),
        FSM_CTRL_FLIGHT_FSM_SEGMENTED_MISSION_COMMAND_TRANSITIONS(SuperSegment1),
        FSM_CTRL_FLIGHT_FSM_SEGMENTED_MISSION_COMMAND_TRANSITIONS(SuperSegment2),
        FSM_CTRL_FLIGHT_FSM_SEGMENTED_MISSION_COMMAND_TRANSITIONS(SuperSegment3),
        FSM_CTRL_FLIGHT_FSM_SEGMENTED_MISSION_COMMAND_TRANSITIONS(Landing),
        FSM_CTRL_FLIGHT_FSM_SEGMENTED_MISSION_COMMAND_TRANSITIONS(Emergency),
        FSM_CTRL_FLIGHT_FSM_SEGMENTED_MISSION_COMMAND_TRANSITIONS(SafeNoop));
  }
};
