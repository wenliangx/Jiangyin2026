...
extern bool odometry_publish_tf;
...
extern double odometry_publish_rate_hz;
extern std::string odometry_topic, output_frame_id, output_child_frame_id;
extern M3D Body_R_wrt_IMU;
extern V3D Body_T_wrt_IMU;
